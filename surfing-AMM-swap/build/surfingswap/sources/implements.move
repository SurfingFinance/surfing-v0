...
module surfingswap::implements {
    ...
    use surfingswap::comparator;
    use surfingswap::math;

    friend surfingswap::beneficiary;
    friend surfingswap::controller;
    friend surfingswap::interface;
